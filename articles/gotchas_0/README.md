...
- [SystemVerilog Gotchas, Tips and Tricks, часть 1](#systemverilog-gotchas-tips-and-tricks-часть-1)
  ...
  - [Совместный запуск последовательностей на множестве агентов](#Совместный-запуск-последовательностей-на-множестве-агентов)
...
Давайте уберем промежуточную переменную `j`s:
