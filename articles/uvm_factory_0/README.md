...
Исходные файлы библиотеки UVM версии 1.2 можно скачать на сайте компании Accellera по [ссылке](https://www.accellera.org/images/downloads/standards/uvm/uvm-1.2.tar.gz).
